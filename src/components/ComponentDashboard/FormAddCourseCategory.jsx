...
import useAddCourseCategory from "../../hooks/useAddCourseCategory";

const FormAddCourseCategory = () => {
  const {
    formData,
    isLoading,
    error,
      ...
      >
        ...
        <Snackbar open={error || success} autoHideDuration={3000}>
          <Alert
            ...
            sx={{ width: "100%" }}
          >
            {success ? "Course added successfully" : error}
          </Alert>
        </Snackbar>
      </Box>
    </Box>
...
export default FormAddCourseCategory;
